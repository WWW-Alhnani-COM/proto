...
export default function SplashCursor({
  ...
  useEffect(() => {
    try {
      ...
      console.warn('WebGL غير مدعوم:', error);
  ...
  useEffect(() => {
    if (isWebGLSupported === false) {
      console.warn('تم تعطيل SplashCursor بسبب عدم دعم WebGL');
      return;
    }

    if (isWebGLSupported === null) return;
    ...
    try {
      ...
      if (!ext.supportLinearFiltering) {
        // يمكن تعديل الإعدادات هنا إذا لزم الأمر
      }
      ...
      function getWebGLContext(canvas: HTMLCanvasElement) {
        try {
          ...
          if (!formatRGBA || !formatRG || !formatR) {
            console.warn('فشل تهيئة تنسيقات النسيج');
            return null;
          }
          ...
          console.warn('خطأ في تهيئة WebGL:', error);
          return null;
        }
      }
      ...
      console.warn('خطأ في تهيئة SplashCursor:', error);
    }
  }, [
    SIM_RESOLUTION,
    DYE_RESOLUTION,
